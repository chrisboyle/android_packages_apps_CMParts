...
public final class LocaleFire extends BroadcastReceiver
{
	...
	public void onReceive(final Context context, final Intent intent)
	{
		if (ACTION_FIRE_SETTING.equals(intent.getAction())) {
			final Bundle forwardedBundle = intent.getBundleExtra(LocaleRenderEdit.EXTRA_BUNDLE);
			if (forwardedBundle == null) return;
			final int effect = forwardedBundle.getInt(LocaleRenderEdit.EXTRA_RENDER_EFFECT, 0);
